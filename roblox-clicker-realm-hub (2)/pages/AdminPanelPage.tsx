...
const dailyJoinsData: AdminStatsData[] = [ // This data would ideally come from a backend
...
const AdminPanelPage: React.FC = () => {
  ...
  useEffect(() => {
    if (authUsers) {
      setLocalUsers(authUsers.filter(u => u.id !== currentUser?.id)); // Don't show current admin in list for self-management
    }
