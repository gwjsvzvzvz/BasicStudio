      ...
      try {
        ...
        if (fetchedItems && Array.isArray(fetchedItems)) {
          setItems(fetchedItems.map((item, index) => ({
            ...
            imageUrl: `https://picsum.photos/seed/${item.title || `item${index}`}/400/300`,
            type: item.type || itemTypes[index % itemTypes.length] // Assign type if missing
          })));
        } else {
          setError("Could not fetch showcase items. Displaying placeholders.");
          // Placeholder data
          const placeholderItems: ShowcaseItem[] = [
            { id: 'art-1', title: 'Cosmic Clicker', description: 'My fan art of the legendary Cosmic Clicker item!', imageUrl: 'https://picsum.photos/seed/cosmicart/400/300', type: 'Art', author: 'PixelPainterX' },
            { id: 'model-1', title: 'Dragon Pet Model', description: 'A 3D model of a new dragon pet concept.', imageUrl: 'https://picsum.photos/seed/dragonmodel/400/300', type: 'Model', author: '3DMaster' },
            { id: 'script-1', title: 'Auto-Sell Script', description: 'A handy script to auto-sell items when inventory is full.', imageUrl: 'https://picsum.photos/seed/scriptbg1/400/300', type: 'Script', author: 'CodeWizard' },
            { id: 'art-2', title: 'Galaxy Background', description: 'A cool background for the game lobby.', imageUrl: 'https://picsum.photos/seed/galaxyart/400/300', type: 'Art', author: 'SpaceArtist' },
          ];
