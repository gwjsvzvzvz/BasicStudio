  ...
  return (
    <div className={cardClasses} onClick={onClick}>
      ...
      <div className="p-6">
        ...
        {/* Removed prose classes as Tailwind base styles + custom theme should handle typography. Re-add if specific prose styling is desired. */}
        <div className="text-textSecondary max-w-none">{children}</div>
      </div>
    </div>
  );
};
